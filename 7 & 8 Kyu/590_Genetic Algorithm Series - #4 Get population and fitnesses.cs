/*Challenge link:https://www.codewars.com/kata/567b468357ed7411be00004a/train/csharp
Question:
...
⣤⣠⡈⠙⠛⠛⠶⠶⠟⠛⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
*/
//x is the curretn element
//from p(population), create new ChromosomeWrap, set Chromosome to x, and set Fitness by passing x into f, 
//then return the enumerable result
using System;
using System.Collections.Generic;
using System.Linq;

public class Kata{
    public IEnumerable<ChromosomeWrap> MapPopulationFit(IEnumerable<string> p, Func<string, double> f) =>
      p.Select(x => new ChromosomeWrap {Chromosome  = x, Fitness  = f(x)});
}
