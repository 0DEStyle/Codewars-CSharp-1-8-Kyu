/*Challenge link:https://www.codewars.com/kata/581e1d083a4820eb4f00004f/train/csharp
Question:
...
//find remainder
public class Kata{
  public static int Mod256WithoutMod(int n) => n - (n/256*256);
}
...
public class Kata
{
  ...
  {
     int mod =  number & 255  ;
     return ( number >=0 || mod ==0) ? mod :  mod - 256;
  }
}
//****************Sample Test*****************
namespace Solution 
{
  ...
  public class KataTests
  {
    ...
    {
      if(CheatingPrevention.CheatingDetection())
      {
        Assert.Fail("You are not allowed to use the %-operator!");
      }
    }
    ...
    public void RandomTests()
    {
      ...
      for(int r=0;r<40;r++)
      {
        int number = rand.Next(-10000, 10001);
        Assert.AreEqual(number % 256, Kata.Mod256WithoutMod(number));
      }
    }
  }
}
