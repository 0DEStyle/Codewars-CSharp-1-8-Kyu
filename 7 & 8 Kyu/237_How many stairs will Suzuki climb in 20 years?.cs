/*Challenge link:https://www.codewars.com/kata/56fc55cd1f5a93d68a001d4e/train/csharp
Question:
...
//***************Solution********************
//sum all data for each day in the week, then sum the entire week * 20
using System;
using System.Linq;
public class Kata{
  public static long StairsIn20(int[][] stairs){
    int ans = 0;
    Console.WriteLine(stairs.Length); //day
    Console.WriteLine(stairs[0].Length); //num in day
...
namespace Solution 
{
  ...
  public class KataTests
  {
    ...
    {      
      ...
      Assert.AreEqual(expected, Kata.StairsIn20(stairs));
    }
  ...
  [Test]
    public void RandomTests()
    {
      ...
      for (var i = 0; i < 100; i++) {
          ...
          long expected = StairsIn20Test(stairs);
          for (var j = 0; j < 7; j++) Console.WriteLine("testing Array: {0}", string.Join(", ", stairs[j]));
          Console.WriteLine("<br>Result: {0} <br>", Kata.StairsIn20(stairs));
          Assert.AreEqual(expected, Kata.StairsIn20(stairs));
      }     
    }
  }
