/*Challenge link:https://www.codewars.com/kata/586dd26a69b6fd46dd0000c0/train/csharp
Question:
...
public class Kata{
  public static string MyFirstInterpreter(string code){
    ...
    //loop through each character in the string code
    //if ch is '+', increase memory by 1, else if ch is '.', append char memory to str
    foreach(var ch in code)
      if(ch == '+') memory++;
      else if(ch == '.') str += (char)memory;
...
{
  public static string MyFirstInterpreter(string code)
  => code.Aggregate<char, (string res, byte acc)>(
							("", 0),
							((string res, byte acc) i, char c) => 
								(c == '+') ? (i.res, ++i.acc) : (c == '.') ? (i.res += (char)i.acc, i.acc) : (i.res, i.acc)
						).res;
}
//****************Sample Test*****************
  namespace Solution {
  ...
  public class Test
  {
    ...
    public void SampleTests()
    {
      ...
      Assert.AreEqual("Hello, World!", Kata.MyFirstInterpreter("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.+++++++++++++++++++++++++++++.+++++++..+++.+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.+++++++++++++++++++++++++++++++++++++++++++++++++++++++.++++++++++++++++++++++++.+++.++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++."));
      // Outputs the uppercase English alphabet
      Assert.AreEqual("ABCDEFGHIJKLMNOPQRSTUVWXYZ", Kata.MyFirstInterpreter("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+."));
    }
    
    [Test]
    public void AlternateCharacterTests()
    {
      Assert.AreEqual("Hello, World!", Kata.MyFirstInterpreter("+++++sdfs++++sdf++++sdklfjsdklfdjmvncxmnxmiuroewurwio+++++++++++++2423423++234+23++234+23++342+2++24++234++++++++++++++???++++++%+++++$#$#++++++++.+++++ssdf+++++++++++++++S+SDFSFSFWWET+BCV+BC+VBN+V+X+++.+++++++.WER.+++..++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.+++++++++++++++++++++++++++++++++++++++++++++++++++++++.++++++++++++++++++++++++.+++.++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++."));
      Assert.AreEqual("ABCDEFGHIJKLMNOPQRSTUVWXYZ", Kata.MyFirstInterpreter("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.\n+\n.+\n.+\n.+\n.+.+\n.+.+\n.\r+.+.\n+.+.+.+.+.+.+.+.+.+.+.+.+.+.+."));
      Assert.AreEqual("ABCDEFGHIJKLMNOPQRSTUVWXYZ", Kata.MyFirstInterpreter("+++,++<<-+-+-->>>-+++,++,++<+--+[>-+[--+]+<<<[+,,]+++]>+++,+,+++>>+++,++>[>>>>>]++++,+,+++[+++[+++[++]+++]++[++]--,,->><]+++++++.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+."));
      Assert.AreEqual("ABCDEFGHIJKLMNOPQRSTUVWXYZ", Kata.MyFirstInterpreter("+++n+nnn*se++*e+e+***+enn+nn+***eess+++++s**+n++++++****+++s+s++*+ww++www+**+++++s**++++www***+w+w+www+****++++s+++++www+++s+++ss+ss+ws+s+.+w.s+s.+.+.ww+.s+.sw+ssssssw.+w.+.+s.+.+.+nessew.+.+.+.+.news+.+.+.+sewn.+.sesse+.+.see+.w"));
    }
    
    [Test]
    public void FixedTests()
    {
      Assert.AreEqual("abcdefghijklmnopqrstuvwxyz", Kata.MyFirstInterpreter(new String('+', 97) + ".+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+."));
      Assert.AreEqual("abcdefghijklmnopqrstuvwxyz", Kata.MyFirstInterpreter(new String('+', 97) + ".+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.++++++"));
      Assert.AreEqual("Codewars", Kata.MyFirstInterpreter(new String('+', 67) + "." + new String('+', 44) + "." + new String('+', 245) + ".+." + new String('+', 18) + "." + new String('+', 234) + "." + new String('+', 17) + ".+."));
      Assert.AreEqual("Codewars", Kata.MyFirstInterpreter(new String('+', 67) + "." + new String('+', 44) + "." + new String('+', 245) + ".+." + new String('+', 18) + "." + new String('+', 234) + "." + new String('+', 17) + ".+.+++++"));
      Assert.AreEqual("donaldsebleung", Kata.MyFirstInterpreter(new String('+', 100) + "." + new String('+', 11) + "." + new String('+', 255) + "." + new String('+', 243) + "." + new String('+', 11) + "." + new String('+', 248) + "." + new String('+', 15) + "." + new String('+', 242) + "." + new String('+', 253) + "." + new String('+', 10) + "." + new String('+', 249) + "." + new String('+', 16) + "." + new String('+', 249) + "." + new String('+', 249) + "."));
      Assert.AreEqual("donaldsebleung", Kata.MyFirstInterpreter(new String('+', 100) + "." + new String('+', 11) + "." + new String('+', 255) + "." + new String('+', 243) + "." + new String('+', 11) + "." + new String('+', 248) + "." + new String('+', 15) + "." + new String('+', 242) + "." + new String('+', 253) + "." + new String('+', 10) + "." + new String('+', 249) + "." + new String('+', 16) + "." + new String('+', 249) + "." + new String('+', 249) + ".+++++++++++++++++"));
      Assert.AreEqual("JavaScript", Kata.MyFirstInterpreter(new String('+', 74) + "." + new String('+', 23) + "." + new String('+', 21) + "." + new String('+', 235) + "." + new String('+', 242) + "." + new String('+', 16) + "." + new String('+', 15) + "." + new String('+', 247) + "." + new String('+', 7) + "." + "++++."));
      Assert.AreEqual("JavaScript", Kata.MyFirstInterpreter(new String('+', 74) + "." + new String('+', 23) + "." + new String('+', 21) + "." + new String('+', 235) + "." + new String('+', 242) + "." + new String('+', 16) + "." + new String('+', 15) + "." + new String('+', 247) + "." + new String('+', 7) + "." + "++++.+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++hey sup what's up+++++++++++++++++++++++"));
      Assert.AreEqual("Esolangs rock!!!", Kata.MyFirstInterpreter(new String('+', 69) + "." + new String('+', 46) + "." + new String('+', 252) + "." + new String('+', 253) + "." + new String('+', 245) + "." + new String('+', 13) + "." + new String('+', 249) + "." + new String('+', 12) + "." + new String('+', 173) + "." + new String('+', 82) + "." + new String('+', 253) + "." + new String('+', 244) + ".++++++++." + new String('+', 182) + "...++"));
      Assert.AreEqual("Esolangs rock!!!", Kata.MyFirstInterpreter(new String('+', 69) + "." + new String('+', 46) + "." + new String('+', 252) + "." + new String('+', 253) + "." + new String('+', 245) + "." + new String('+', 13) + "." + new String('+', 249) + "." + new String('+', 12) + "." + new String('+', 173) + "." + new String('+', 82) + "." + new String('+', 253) + "." + new String('+', 244) + ".++++++++." + new String('+', 182) + "...Surely they are ignoring the characters out here, right? ++1 to the code that does"));
    }
    ...
    {
      int loops = rnd.Next(10, 100);
      string result = "";
      for (int i = 0; i < loops; ++i)
      {
        result += new String('+', rnd.Next(3, 256)) + '.';
      }
      return result;
    }
    ...
    public void RandomTests()
    {
      for (int i = 0; i < 100; ++i)
      {
        string randomProgram = RandomProgram();
        string solution = Solution(randomProgram);
        string attempt = Kata.MyFirstInterpreter(randomProgram);
        Assert.AreEqual(solution, attempt);
      }
    }
  }
}
