/*Challenge link:https://www.codewars.com/kata/564057bc348c7200bd0000ff/train/csharp
Question:
From Wikipedia:
...
public class Thirteen{
  public static long Thirt(long n){
    //repeat pattern
      ...
      for (var i = 0; n > 0; i++){
        //% 6 because seq legnth is 6, n % 10 to get last digit
          sum += n % 10 * seq[i % 6];
        //n / 10 to get next digit, 1234567 / 10 becomes 123456
          n /= 10;
      }
    
    //if sum is greater than 99, pass sum into recurisive method, else return sum
      return sum > 99 ? Thirt(sum) : sum;
  }
}
...
[Test]    
    public static void RandomTest() {
        ...
        for (int i = 0; i < 200; i++) { 
            int n = rnd.Next(150, 1500000000);
            testing(Thirteen.Thirt(n), ThirtSol(n)); 
        }
    }
}  
