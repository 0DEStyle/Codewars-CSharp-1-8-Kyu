/*Challenge link:https://www.codewars.com/kata/554a44516729e4d80b000012/train/csharp
Question:
...
public class BuyCar {
	...
	public static int[] nbMonths(int startPriceOld, int startPriceNew, int savingPerMonth, double percentLossByMonth) {
		        var month = 0;
            double priceNew = startPriceNew, priceOld = startPriceOld, savings = priceOld;

    //create a while loop to check if priceNew is greater than saving
    //increase percentLossBy Month every 2 months
    //recalculate the price of old and new, then find out the saving at the end of month. PriceOld is the price to sell the car.
    ...
    //return the result in correct format.
            return new[] {month, (int) Math.Round(savings - priceNew)};
	}
}
