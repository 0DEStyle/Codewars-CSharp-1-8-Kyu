/*Challenge link:https://www.codewars.com/kata/52a89c2ea8ddc5547a000863/train/csharp
Question:
...
public class Kata{
  public static int getLoopSize(LoopDetector.Node startNode){
    ...
    LoopDetector.Node currentNode = startNode.next; 
    LoopDetector.Node nextNode = startNode.next.next;
    
    //find the cycle where currentNode is equal to nextNode
    while(currentNode != nextNode){
      currentNode = currentNode.next;
      nextNode = nextNode.next.next;
    }

    //find the number of node count until the loop reaches the beginning.
...
public class Tests {
  ...
  public void RandomChainLoopTest500to1000(){
    ...
    Assert.AreEqual(loopSize,Kata.getLoopSize(n1));
